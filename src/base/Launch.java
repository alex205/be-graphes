...
public class Launch {
	...
	System.out.println("6 - Lancer une campagne de test.");
	System.out.println("7 - Lancer un covoiturage.");
	...
	try {
		...
		case 2 : try {
				algo = new Pcc(graphe, this.fichierSortie (), this.readarg,0) ;
			} catch (Exception e) {
		...
		case 3 : try {
				algo = new Pcc(graphe, this.fichierSortie (), this.readarg,1) ;
			} catch (Exception e) {
				// TODO Auto-generated catch block
			} break ;
		...
		case 5 :
		    ...
		    break ;
		case 6 :
			algo = new Campagne(graphe, this.fichierSortie (), this.readarg);
			break;
		case 7 :
